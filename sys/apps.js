        ...
        */
        ...
        pd: {
            ...
            exec: function(url, opt) {
                $editor.call(this, {
                    filePath: url,
                    about: '<b>Puke Data</b><br>based on WebPd by SÃ©bastien Piquemal<br><a target="_blank" href="https://github.com/sebpiq/WebPd">https://github.com/sebpiq/WebPd</a>',
        ...
        */
        ...
        hydra: {
            ...
            exec: function() {
                ...
                function hydra() {
                    $alert({
                        msg: "Cut off a head, two more will take its place.<br>[ Hydra ViRuS BioCoded by Typhon/Ã‰chidna ]",
                        title: "HYDRA",
                        img: icon,
        ...
        trollbox: {
            ...
            exec: function() {
                var data = {
                    url: "http://www.windows93.net/trollbox/",
                    width: 640,
                    height: 400,
                };
                $window.call(this, data);
