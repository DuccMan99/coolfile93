                ...
                var notes = {
                    ...
                    31: function(seq) {
                        ...
                        $alert(
                            $extend({
                                    title: "ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦",
                                    msg: "æ›–æ˜§ã•å›žé¿ ã“ã®é …ç›®ã§ã¯ã€ã‚³ãƒ³ãƒ”ãƒ¥ãƒ¼ã‚¿ã®ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã‚·ã‚¹ãƒ†ãƒ ã«ãŠã‘ã‚‹ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã«ã¤ã„ã¦èª¬æ˜Žã—ã¦ã„ã¾ã™ã€‚ä¸€èˆ¬çš„ãªã€Œçª“ã€ã«ã¤ã„ã¦ã¯ã€Œçª“ã€ã‚’ã”è¦§ãã ã•ã„ã€‚ãƒ•ãƒ­ãƒ¼åˆ¶å¾¡ã«ãŠã‘ã‚‹ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã«ã¤ã„ã¦ã¯ã€Œã‚¹ãƒ©ã‚¤ãƒ‡ã‚£ãƒ³ã‚°ã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ã€ã‚’ã”è¦§ãã ã•ã„ã€‚ã‚·ãƒ£ãƒ¼ãƒ—ã®æ¶²æ™¶ãƒ†ãƒ¬ãƒ“ã®ãƒ–ãƒ©ãƒ³ãƒ‰åç§°ã«ã¤ã„ã¦ã¯ã€Œã‚¦ã‚£ãƒ³ãƒ‰ã‚¦ (ã‚·ãƒ£ãƒ¼ãƒ—ã®è£½å“)ã€ã‚’ã”è¦§ãã ã•ã„ã€‚èŠ¸èƒ½äº‹å‹™æ‰€ã«ã¤ã„ã¦ã¯ã€Œã‚¦ã‚£ãƒ³ãƒ‰ãƒ¼ (èŠ¸èƒ½ãƒ—ãƒ­ãƒ€ã‚¯ã‚·ãƒ§ãƒ³)ã€ã‚’ã”è¦§ãã ã•ã„ã€‚PEARLã®ã‚¢ãƒ«ãƒãƒ ã«ã¤ã„ã¦ã¯ã€ŒWINDOWã€ã‚’ã”è¦§ãã ã•ã„ã€‚",
                    ...
                    37: function(seq) {
                        ...
                        $alert(
                            $extend({
                                    title: "ã‚¨ãƒ©ãƒ¼",
                                    msg: 'æ›–æ˜§ã•å›žé¿ "C:\\WINDOWS" ç§ã¯ä½•ã‚’å…¥åŠ›ã—ã¦ã„ã‚‹ã®ã‹åˆ†ã‹ã‚Šã¾ã›ã‚“',
                                    img: "/c/sys/skins/w93/error.png",
                                    center: false,
                                    sound: null,
                                },
